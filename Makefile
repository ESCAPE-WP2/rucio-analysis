...
skao:
	@docker build . -f Dockerfile --build-arg BASEIMAGE=registry.gitlab.com/ska-telescope/src/ska-rucio-client --build-arg BASETAG=release-1.26.2 --no-cache --tag rucio-analysis:skao
