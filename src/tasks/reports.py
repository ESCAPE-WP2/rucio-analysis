            ...
            for rse in rses:
                ...
                for webhook in webhooks:
                    if webhook["type"] == "slack":
                        ...
                        if (
                            nDocsAsSrc["is_stuck"] > percentageStuckWarningThreshold
                            or nDocsAsSrc["is_submitted"] == 0
                        ):
                            symbol = ":warning:"
                        else:
                            symbol = ":ok:"
                        blocks.append(
                            {
                                ...
                                "text": {
                                    ...
                                    + ":x: {:4d}\t:".format(nDocsAsSrc["is_stuck"])
                        ...
                        if (
                            nDocsAsDst["is_stuck"] > percentageStuckWarningThreshold
                            or nDocsAsDst["is_submitted"] == 0
                        ):
                            symbol = ":warning:"
                        else:
                            symbol = ":ok:"
                        blocks.append(
                            {
                                ...
                                "text": {
                                    ...
                                    + ":x: {:4d}\t:".format(nDocsAsDst["is_stuck"])
                                    + "arrow_forward: {:4d}".format(
